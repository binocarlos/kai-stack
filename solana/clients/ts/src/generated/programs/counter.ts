...
export const COUNTER_PROGRAM_ADDRESS =
  "8yy1KCyWhqUxgebL6yvZeiA7NwLRQnEuxj9AoSSvYKTR" as Address<"8yy1KCyWhqUxgebL6yvZeiA7NwLRQnEuxj9AoSSvYKTR">;
...
export type ParsedCounterInstruction<
  TProgram extends string = "8yy1KCyWhqUxgebL6yvZeiA7NwLRQnEuxj9AoSSvYKTR",
> =
  | ({
...
export function counterProgram() {
  return <T extends CounterPluginRequirements>(
    client: T,
  ): Omit<T, "counter"> & { counter: CounterPlugin } => {
