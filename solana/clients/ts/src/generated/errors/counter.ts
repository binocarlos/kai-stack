...
/** Overflow: counter overflowed u64 */
export const COUNTER_ERROR__OVERFLOW = 0x1770; // 6000

export type CounterError = typeof COUNTER_ERROR__OVERFLOW;

let counterErrorMessages: Record<CounterError, string> | undefined;
if (process.env["NODE_ENV"] !== "production") {
  counterErrorMessages = {
    [COUNTER_ERROR__OVERFLOW]: `counter overflowed u64`,
  };
}
